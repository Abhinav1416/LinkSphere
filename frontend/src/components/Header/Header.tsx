...
import logo from '../../assets/linksphere-logo.png'; // Add this at the top with your other imports
        ...
        <div className={classes.left}>
          <NavLink to="/">
            <img
              src={logo}
              alt="LinkSphere Logo"
              className={classes.logo} // keep if you want to apply same styling
              style={{ height: "40px", objectFit: "contain" }} // optional inline style
            />
          </NavLink>
